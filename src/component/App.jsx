...
import Content from "./Prediction/Content";
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Routes>
        <Route exact path="/Robot-Care/Prediction" element={<List keys={keys} />}>
          <Route
            exact
            path=":key"
            element={
        ...
        <Route exact path="/" element={<Navigate to="/Robot-Care" />} />
        <Route exact path="/Robot-Care" element={<Chatbot />} />
        <Route exact path="/Robot-Care/Home" element={<Chatbot />} />
        <Route exact path="/Robot-Care/About" element={<About />} />
        <Route exact path="/Robot-Care/firstaid" element={<FirstAid />} />
      </Routes>
